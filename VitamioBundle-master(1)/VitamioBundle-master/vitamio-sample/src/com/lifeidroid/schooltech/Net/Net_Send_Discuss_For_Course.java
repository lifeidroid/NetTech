...
public class Net_Send_Discuss_For_Course {
	public Net_Send_Discuss_For_Course(String email, String token, int schoolId,
			int deptId, int courseId, String content, String grade,
		...
		new NetConnection(Config.URL, HttpMethod.POST,
				...
				}, Config.KEY_ACTION, Config.ACTION_SENDDISCUSS,
				...
				Config.KEY_GRADE, grade, Config.KEY_MSG, content);
	}
