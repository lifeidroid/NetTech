...
public class Net_Send_Note_For_Course {
	public Net_Send_Note_For_Course(String email, String token, int schoolId,
			int deptId, int courseId, String content,final SuccessCallback successCallback ,final FailCallback failCallback) {
