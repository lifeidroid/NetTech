...
public class Net_SetCollection {
	public Net_SetCollection(String email, String token, int schoolId,
			int deptId, int courseId,int noteId,int whetherCollect,final SuccessCallback successCallback,final FailCallback failCallback) {
